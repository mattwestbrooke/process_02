...
# Form implementation generated from reading ui file 'add_filter_UI.ui'
#
# Created: Tue Dec 20 15:15:55 2016
...
class filter_UI(QtGui.QWidget):
    ...
    def __init__(self):
        ...
        self.new_var_3.editingFinished.connect(self.handle_le_sig)
        self.save_b.setHidden(True)

    def handle_le_sig(self):
        if self.new_var_3.isModified():
            self.update_vars()
    ...
    def set_variables(self, filt_vars):
        ...
        self.new_var_3.setText(filt_vars[3])
    ...
    def update_vars(self):
        update = [str(self.name_1.text()), self.gfilt_vars, str(self.var_2.currentText()), str(self.new_var_3.text())]
    ...
    def setupUi(self):
        ...
        self.new_var_3 = QtGui.QLineEdit(self.frame_2)
        self.new_var_3.setText("")
        self.new_var_3.setObjectName("new_var_3")
        self.horizontalLayout_5.addWidget(self.new_var_3)
    ...
    def retranslateUi(self):
        ...
        self.label.setText(QtGui.QApplication.translate("Form", "Add text:", None, QtGui.QApplication.UnicodeUTF8))
