...
# test_data_object_list.create_new_data_object_and_set_variables(0, [["[SOURCE_TEXT]", "AVE_101_SC020_SH005"],["[MATCHED]", "True"],["shotX", "010"],["sceneX", "022"]])
# test_data_object_list.create_new_data_object_and_set_variables(1, [["[SOURCE_TEXT]", "AVE_102_SC010_SH006"],["[MATCHED]", "True"],["shotX", "020"],["sceneX", "022"]])
# test_data_object_list.create_new_data_object_and_set_variables(2, [["[SOURCE_TEXT]", "AVE_103_SC070_SH007"],["[MATCHED]", "True"],["shotX", "030"],["sceneX", "022"]])
# test_data_object_list.create_new_data_object_and_set_variables(3, [["[SOURCE_TEXT]", "AVE_104_SC060_008"],["[MATCHED]", "False"],["shotX", "040"],["sceneX", "022"]])
...
#
#
# test_output_object.setup_processes_to_file("test_01")
# #print "outputs ---- "
...
print "search found -- "
next_event = test_process_list.find_next_event_to_process()
print next_event
